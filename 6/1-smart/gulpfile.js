...
const config = {
    src: './src/',
    css: {
        watch: '/precss/**/*.scss', //следим за всеми файлами .scss
        //билдим только основной файл styles.scss( который подключает вспомогательные файлы)
        src: '/precss/+(styles|styles-ie9).scss', //для всех браузеров берём styles.scss, если не сработает то берём файл styles-ie9.scss
        dest: '/css'
    },
    html: {
        src: '/index.html', //Дз
